...
export const validateGamePOSTData = () => [
    ...
    body('game_start')
        .isISO8601()
        .withMessage('Invalid date format. Use ISO8601 format for game start date'),

    body('game_venue')
        .notEmpty()
        .withMessage('Game venue cannot be empty')
        .isString()
        .withMessage('Game venue must be a string'),

    body('team1')
        .notEmpty()
        .withMessage('Team 1 name cannot be empty')
        .isString()
        .withMessage('Team 1 name must be a string'),

    body('team2')
        .notEmpty()
        .withMessage('Team 2 name cannot be empty')
        .isString()
        .withMessage('Team 2 name must be a string'),
];
